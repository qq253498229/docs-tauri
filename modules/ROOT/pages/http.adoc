[[http]]
= http
:http_url: https://github.com/tauri-apps/tauri/blob/73a0ad4/tooling/api/src/http.ts
:record_url: https://www.typescriptlang.org/docs/handbook/utility-types.html#recordkeys-type
:omit_url: https://www.typescriptlang.org/docs/handbook/utility-types.html#omittype-keys
...
- `Static` bytes(``bytes``: `Iterable`<``number``> | `link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer[ArrayBuffer]` | `ArrayLike`<``number``>): `<<body,Body>>`
...
|===
|名称|类型|描述
|`bytes`|`Iterable`<``number``> \| `link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer[ArrayBuffer]` \| ``ArrayLike``<``number``>|请求体字节数组。
|===
...
- `Static` form(`data`: `link:{record_url}[Record]`<``string``, `<<part,Part>>`> | `link:https://developer.mozilla.org/en-US/docs/Web/API/FormData[FormData]`): <<body,Body>>
...
|===
|名称|类型|描述
|`data`|`link:{record_url}[Record]`<``string``, `<<part,Part>>`>\|``link:https://developer.mozilla.org/en-US/docs/Web/API/FormData[FormData]``|请求体数据。
|===
...
- Part: `string` | `link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array[Uint8Array]` | `<<file-part,FilePart>>`<``link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array[Uint8Array]``>
