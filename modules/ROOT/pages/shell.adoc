...
- write(``data``: `string` | `link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array[Uint8Array]`): `{promise_url}[Promise]`<``void``>
...
|===
|名称|类型|描述
|`data`|`string` \| `link:https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Uint8Array[Uint8Array]`|消息要写的内容，可以是字符串或者字节数组。
|===
